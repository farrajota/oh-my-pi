 ...
 * prefix. Stores a sha-256 of the account + billing-scope tuple instead of the
 * raw email/uuid/org; note an unsalted digest of a guessable email is
...
export interface SessionInitEntry extends SessionEntryBase {
	...
	/** Effective MCP policy for this child; absent only on legacy session files. */
	enableMCP?: boolean;
