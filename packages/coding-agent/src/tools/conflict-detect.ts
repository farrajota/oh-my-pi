...
export type { ConflictEntry, ConflictScope } from "@oh-my-pi/pi-tui/tools/conflict-detect";
export { renderConflictRegion } from "@oh-my-pi/pi-tui/tools/conflict-detect";
/**
