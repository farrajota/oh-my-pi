...
/** Record artifact locations and mark the result as isolated. */
function rememberAgentArtifacts(
	...
	if (historyAuthority) setAgentHistory(registry, historyAuthority, history);
	else registry.setHistory(result.id, history);
