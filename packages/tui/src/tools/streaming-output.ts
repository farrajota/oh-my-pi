...
type ArtifactPublisher = (artifactPath: string) => Promise<void>;

let artifactPublisher: ArtifactPublisher | undefined;

export function setArtifactPublisher(publisher: ArtifactPublisher): void {
...
export class OutputSink {
	...
	async dump(notice?: string): Promise<OutputSummary> {
		...
		if (this.#artifactPath && this.#artifactId && artifactPublisher) {
			try {
				await artifactPublisher(this.#artifactPath);
			} catch {}
		}
