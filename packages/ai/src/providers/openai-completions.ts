 ...
 * assistant output commits the attempt. HTTP failures are already retried within
 * `postOpenAIStream`, so replaying their finalized status here would exceed the
